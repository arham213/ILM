...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.NoteViewHolder> implements Filterable {
    ...
    public AdminAdapter(ArrayList<Question> myDataset, QuestionItemClickListener ls) {
        mDataset = myDataset;
    ...
    public void onBindViewHolder(NoteViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), AnswerQuestion.class);
